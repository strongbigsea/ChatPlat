...
class UserInfoBaseTest : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_max_t() const;
  inline void clear_max_t();
  static const int kMaxTFieldNumber = 33;
  inline ::google::protobuf::uint32 max_t() const;
  inline void set_max_t(::google::protobuf::uint32 value);
 ...
 private:
  ...
  inline void set_has_max_t();
  inline void clear_has_max_t();
...
// optional uint32 max_t = 33;
inline bool UserInfoBaseTest::has_max_t() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void UserInfoBaseTest::set_has_max_t() {
  _has_bits_[0] |= 0x00000010u;
}
inline void UserInfoBaseTest::clear_has_max_t() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void UserInfoBaseTest::clear_max_t() {
  max_t_ = 0u;
  clear_has_max_t();
}
inline ::google::protobuf::uint32 UserInfoBaseTest::max_t() const {
  return max_t_;
}
inline void UserInfoBaseTest::set_max_t(::google::protobuf::uint32 value) {
  set_has_max_t();
  max_t_ = value;
}
