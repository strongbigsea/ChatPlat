...
void protobuf_AddDesc_message_5fdefine_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "req\030\006 \001(\0132\021.ssp.DelFriendReq\0223\n\023publish_"
    "message_req\030\007 \001(\0132\026.ssp.PublishMessageRe"
    "q\022\'\n\rget_photo_req\030\010 \001(\0132\020.ssp.GetPhotoR"
    "eq\0224\n\024get_message_list_req\030\t \001(\0132\026.ssp.G"
    "etMessageListReq\"\371\002\n\tCommonRsp\022\036\n\006header"
    ...
    "riendRsp\0223\n\023publish_message_rsp\030\007 \001(\0132\026."
    "ssp.PublishMessageRsp\022\'\n\rget_photo_rsp\030\010"
    " \001(\0132\020.ssp.GetPhotoRsp\0224\n\024get_message_li"
    "st_rsp\030\t \001(\0132\026.ssp.GetMessageListRsp", 2076);
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(66)) goto parse_get_photo_req;
        break;
      }

      // optional .ssp.GetPhotoReq get_photo_req = 8;
      case 8: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_get_photo_req:
        ...
        if (input->ExpectTag(74)) goto parse_get_message_list_req;
        break;
      }

      // optional .ssp.GetMessageListReq get_message_list_req = 9;
      case 9: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
...
void CommonReq::SerializeWithCachedSizes(
  ...
  if (has_get_photo_req()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      8, this->get_photo_req(), output);
  }

  // optional .ssp.GetMessageListReq get_message_list_req = 9;
  if (has_get_message_list_req()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      9, this->get_message_list_req(), output);
  }
...
::google::protobuf::uint8* CommonReq::SerializeWithCachedSizesToArray(
  ...
  if (has_get_message_list_req()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        9, this->get_message_list_req(), target);
  }
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(66)) goto parse_get_photo_rsp;
        break;
      }

      // optional .ssp.GetPhotoRsp get_photo_rsp = 8;
      case 8: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_get_photo_rsp:
        ...
        if (input->ExpectTag(74)) goto parse_get_message_list_rsp;
        break;
      }

      // optional .ssp.GetMessageListRsp get_message_list_rsp = 9;
      case 9: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
...
void CommonRsp::SerializeWithCachedSizes(
  ...
  if (has_get_photo_rsp()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      8, this->get_photo_rsp(), output);
  }

  // optional .ssp.GetMessageListRsp get_message_list_rsp = 9;
  if (has_get_message_list_rsp()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      9, this->get_message_list_rsp(), output);
  }
...
::google::protobuf::uint8* CommonRsp::SerializeWithCachedSizesToArray(
  ...
  if (has_get_message_list_rsp()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        9, this->get_message_list_rsp(), target);
  }
