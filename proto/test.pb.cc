...
void protobuf_AssignDesc_test_2eproto() {
  ...
  static const int UserInfoBaseTest_offsets_[5] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(UserInfoBaseTest, max_num_),
  };
...
const int UserInfoBaseTest::kMaxNumFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(264)) goto parse_max_num;
        break;
      }
...
void UserInfoBaseTest::SerializeWithCachedSizes(
  ...
  // optional uint32 max_num = 33;
  if (has_max_num()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(33, this->max_num(), output);
  }
...
::google::protobuf::uint8* UserInfoBaseTest::SerializeWithCachedSizesToArray(
  ...
  // optional uint32 max_num = 33;
  if (has_max_num()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(33, this->max_num(), target);
  }
